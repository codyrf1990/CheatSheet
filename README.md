...
Interactive reference for the SolidCAM team that combines the package matrix and maintenance lookups. Everything runs client-side – open `index.html` in any modern browser and you’re ready to work offline.
...
3. Assets live under `assets/`:
   - `assets/css/main.css` – styling for the layout and calculator.
   - `assets/js/app.js` – bootstraps the UI.
   - `assets/js` modules – `dom.js` (main render + behaviors), `calculator.js`, and supporting helpers.
